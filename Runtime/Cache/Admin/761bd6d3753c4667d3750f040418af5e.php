...
<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
    <li><a href="<?php echo u('admin/index/index');?>"><i class="fa fa-home"></i> Home</a></li>

    <li class="active">类型属性列表</li>
</ul>
<div class="m-b-md">
    <h3 class="m-b-none">类型属性列表</h3>
</div>
<section class="scrollable wrapper">
    ...
    <table class="table table-hover">
        ...
        <?php if(is_array($category)): foreach($category as $key=>$vo): ?><tr>
                <td><?php echo ($vo['cid']); ?></td>
                <td><?php echo ($vo['_cname']); ?></td>
                <td>
                    <div class="btn-group">
                        <a href="<?php echo u('admin/cate/addson',['cid'=>$vo['cid']]);?>" class="btn btn-success">添加子类</a>
                        <a href="<?php echo u('admin/cate/edit',['cid'=>$vo['cid']]);?>" class="btn btn-primary">编辑</a>
                        <a href="javascript:;" onclick="del(<?php echo ($vo['cid']); ?>)" class="btn btn-danger">删除</a>
                    </div>
                </td>
            </tr><?php endforeach; endif; ?>
        </tbody>
    </table>
    <span style="display:block;width: 70%;font-size: 20px; color: red;text-align: center; "><?php echo ($page); ?></span>
</section>
<script>
    function del(cid) {
        util.confirm('确定删除吗?',function(){
            location.href = '/shop/admin/cate/del?cid='+cid;
        })
    }
</script>

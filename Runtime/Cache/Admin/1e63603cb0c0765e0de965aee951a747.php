...
<div class="m-b-md">
    <h3 class="m-b-none">分类添加</h3>
</div>
<div class="row" ng-controller="ctrl">
    <div class="col-sm-12">
        <section class="panel panel-default">
            <header class="panel-heading font-bold">分类添加</header>
                ...
                <form role="form" action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="js-example-basic-single form-control" name="tid">
                            <?php if(is_array($type)): foreach($type as $key=>$vo): ?><option value="<?php echo ($vo['tid']); ?>" <?php if($oldData['tid']==$vo['tid']){ ?> selected='selected'<?php }?>  ><?php echo ($vo['type']); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>

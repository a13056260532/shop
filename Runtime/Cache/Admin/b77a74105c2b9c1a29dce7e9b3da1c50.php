...
<section class="scrollable wrapper">
    ...
    <table class="table table-hover">
        ...
        <?php if(is_array($type)): foreach($type as $key=>$vo): ?><tr>
            ...
            <td>
                <div class="btn-group">
                    <a href="<?php echo u('admin/Typeattribute/lists',['tid'=>$vo['tid']]);?>" class="btn btn-warning">编辑类型属性</a>
                    <a href="<?php echo u('admin/type/add',['tid'=>$vo['tid']]);?>" class="btn btn-primary">编辑</a>
                    <a href="javascript:;" onclick="del(<?php echo ($vo['tid']); ?>)" class="btn btn-danger">删除</a>
                </div>
            </td>
...
<script>
    function del(tid) {
        util.confirm('确定删除吗?',function(){
            location.href = '/shop/admin/type/del?tid='+tid;
        })
    }
</script>
                    </section>
